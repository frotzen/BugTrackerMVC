...
namespace BugTrackerMVC.Controllers
{
    public class InvitesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["InviterId"] = new SelectList(_context.Set<BTUser>(), "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,InviteDate,JoinDate,CompanyToken,CompanyId,ProjectId,InviterId,InviteeId,InviteeEmail,InviteeFirstName,InviteeLastName,Message,IsValid")] Invite invite)
        {
